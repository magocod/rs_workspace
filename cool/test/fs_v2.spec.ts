...
describe("fs", function () {
    ...
    describe("read", function () {
        ...
        it("readFileSync not exist", function () {
            ...
            assert.equal(jsError, "ENOENT: no such file or directory, open '/dir/not_exit'");
            // assert.equal(napiError, "ENOENT: no such file or directory, open '/dir/not_exit'");
            assert.isNotNull(napiError);
        });
